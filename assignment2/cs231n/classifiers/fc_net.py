...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        a,cache_a=affine_relu_forward(X,self.params['W1'],self.params['b1'])
        b,cache_b=affine_forward(a,self.params['W2'],self.params['b2'])
        scores=b
        ...
        dloss2,grads['W2'],grads['b2']=affine_backward(dloss,cache_b)
        dloss3,grads['W1'],grads['b1']=affine_relu_backward(dloss2,cache_a)
...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for i in range(len(hidden_dims)):
          ...
          b_name='b'+str(i+1)
          if(i==0):
            self.params[w_name]=weight_scale*np.random.normal(size=(input_dim,hidden_dims[i]))
          else:
        ...
        self.params[w_name]=weight_scale*np.random.normal(size=(hidden_dims[-1],num_classes))
    ...
    def loss(self, X, y=None):
        ...
        dloss,grads[w_name],grads[b_name]=affine_backward(dloss,now_cache)
